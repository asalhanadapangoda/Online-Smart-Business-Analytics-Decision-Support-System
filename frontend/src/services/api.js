...
export const recommendationsApi = {
  getChurn: (customerId, branchId) => api.get(`/v1/recommendations/churn/${customerId}`, { params: { branchId } }),
  getBusiness: (branchId) => api.get('/v1/recommendations/business', { params: { branchId } }),
};
